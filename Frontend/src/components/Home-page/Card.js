...
function Card() {
  ...
  return (
    <div className="home-cards-bg">
      <div className="container" style={{ justifyContent: 'flex-start', padding: '0 0 0 18%' }}>
        <div className="card">
      ...
      <div className="container" style={{ justifyContent: 'flex-end', padding: '0 12% 0 0' }}>
        <div className="card">
          <div className="content">
            <h1>2</h1>
      ...
      <div className="container" style={{ justifyContent: 'flex-start', padding: '0 0 0 11%' }}>
        <div className="card">
          <div className="content">
            <h1>3</h1>
